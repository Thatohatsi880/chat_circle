        ...
        <div className="flex-1 p-4 mt-8">
          <div className="flex justify-between items-center mb-4 border border-grey-200 border-t-0 border-l-0 border-r-0 pb-6">
            <div className="flex gap-5 justify-between items-center border">
              ...
              <h1 className="text-2xl font-normal">Make a Post</h1>
            </div>

            <button className="text-primaryOrange hover:bg-primaryOrange hover:text-white border border-primaryOrange py-2 px-4 rounded rounded-xl text-center font-bold">
              Save To Draft
            </button>
          </div>
          ...
          <div className="border rounded rounded-2xl bg-gray-100 p-3 flex justify-between gap-8">
            <form onSubmit={handleSubmit} className="w-auto">
              ...
              <div className="mb-4 flex items-center">
                ...
                <span className="text-gray-500 text-sm">
                  Your post will be displayed as anonymous and others won't be
                  able to see your name/profile or message you.
                </span>
              </div>
              <div className="mb-4">
                <label className="block text-gray-700 mb-2">
                  Question Tags (up to 10)
                </label>
                <input
                  type="text"
                  className="border rounded w-full py-2 px-3"
              ...
              <div className="mb-4">
                ...
                />
                <button className="mt-2 bg-primaryOrange text-white hover:text-primaryOrange hover:bg-white border border-primaryOrange py-2 px-4 rounded rounded-xl text-center ">
                  Verify
                </button>
              </div>
              <div className="flex justify-center">
                <button
                  type="submit"
                  className="bg-primaryOrange text-white hover:text-primaryOrange hover:bg-white border border-primaryOrange py-2 px-4 rounded rounded-xl text-center font-bold"
                >
                  Create
                </button>
              </div>
            ...
            <div className="w-2/6 p-4 hidden lg:block">
              <div className="">
                <h2 className="text-lg font-bold text-textGrey">
                  Group Category
                </h2>
                <p className="text-textGrey text-sm">
                  How will you categorize your post
                </p>
              </div>
              <div className="bg-white border mt-5 shadow-md px-6 py-8 flex flex-col gap-10">
                <h3
                  className="text-gray-700 font-bold cursor-pointer flex items-center justify-between"
                  onClick={() => toggleCategories("scienceTechnology")}
                >
                ...
                <h3
                  className="text-gray-700 font-bold cursor-pointer flex items-center justify-between"
                  onClick={() => toggleCategories("artsEntertainment")}
                >
                ...
                <h3
                  className="text-gray-700 font-bold cursor-pointer flex items-center justify-between"
                  onClick={() => toggleCategories("businessFinance")}
                >
                ...
                <h3
                  className="text-gray-700 font-bold cursor-pointer flex items-center justify-between"
                  onClick={() => toggleCategories("lifestyleWellness")}
                >
                ...
                <h3
                  className="text-gray-700 font-bold cursor-pointer flex items-center justify-between"
                  onClick={() => toggleCategories("hobbiesInterests")}
                >
