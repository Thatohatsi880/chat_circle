      ...
      <div className="w-full md:w-[55%] flex justify-center items-center p-4">
        <div className="p-6 rounded shadow-md w-full max-w-md flex flex-col gap-1">
          ...
          <p className="text-center text-gray-600 text-sm">
            Please enter your new password below. Must be 8 or more characters
            and contain at least 1 number and 1 special character.
          </p>
          <br />
          ...
          <p className="text-center text-textGrey mt-4">
