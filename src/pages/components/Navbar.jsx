  ...
  return (
    <div className="flex w-full gap-4 justify-between items-center bg-white p-4 border border-grey-200 border-l-0 border-r-0">
      ...
      <div className="flex items-center justify-between ml-14 md:ml-0 flex-grow gap-4 max-w-4xl ">
        <Link to="/" className="text-white text-xl font-bold hidden md:flex">
      ...
      <Link
        to="/CreatePosts"
        className="text-white hover:text-white border bg-primaryOrange border-primaryOrange p-2 min-w-min rounded rounded-xl text-center hidden md:flex "
      >
        ASK A QUESTION
      </Link>
