      ...
      <div className="bg-white shadow-md p-4 flex justify-between items-center">
        ...
        <div className="flex items-center justify-center" style={{ width: '50%' }}>
          <div className="relative w-full flex justify-between items-center">
            <FiSearch className="text-gray-700 h-6 w-6 absolute left-0 ml-3" />
            <input
              type="text"
              placeholder="Search..."
        ...
        <div className="flex items-center space-x-4" style={{ width: '25%' }}>
          <FiMessageSquare className="text-gray-700 h-6 w-6 cursor-pointer" />
          <FiBell className="text-gray-700 h-6 w-6 cursor-pointer" />
          <div className="relative">
            <FiUser className="text-gray-700 h-6 w-6 cursor-pointer" onClick={toggleUserMenu} />
            {userMenuVisible && (
